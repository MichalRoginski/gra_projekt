...
export default class tBOI_4 extends Phaser.Scene
{
    ...
    create()
    {
        ...
        console.log("<game>");
        const map = this.make.tilemap({key: 'dungeon_4'});
        ...
        if(true){
            ...
            if(this.open==false){
                let test = spikes.get(600,360,"spike");
                test = spikes.get(600,408,"spike");
                test = spikes.get(648,312,"spike");
                test = spikes.get(648,456,"spike");
                test = spikes.get(552,312,"spike");
                test = spikes.get(552,456,"spike");
                test = spikes.get(696,264,"spike");
                test = spikes.get(696,504,"spike");
                test = spikes.get(504,264,"spike");
                test = spikes.get(504,504,"spike");
            }
            ...
            if(this.open==false){
                this.shooters.get(600,384,"shooter");
            }
            ...
            if(this.open==false){
                this.flyers.get(120,168,"flyer");
                this.flyers.get(1080,168,"flyer");
                this.flyers.get(216,552,"flyer");  
                this.flyers.get(984,552,"flyer");  
            }
